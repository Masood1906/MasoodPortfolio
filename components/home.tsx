...
export default function Home() {
  // Use a constant for basePath to ensure consistency
  const basePath = "/MasoodPortfolio"
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              ...
              <Button asChild variant="outline" size="lg">
                <a href={`${basePath}/resume.pdf`} download>
                  <Download className="mr-2 h-4 w-4" /> Download Resume
                </a>
              </Button>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                Intelligence and a strong foundation in Machine Learning and front-end development. Skilled in HTML,
                CSS, JavaScript, and responsive design principles, with hands-on experience in creating interactive web
                applications.
              </p>
              <p className="text-muted-foreground">
